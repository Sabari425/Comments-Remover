"""
UNIVERSAL COMMENT REMOVER - DARK HACKER EDITION v5.0
Complete Multi-Language Comment Removal System with Code Formatting
Preserves Originals | Circular Progress | Full Screen | Live DateTime
"""
...
class BatchProcessor:
    ...
    def process_directory(self, source_dir: str, output_dir: str, extensions: List[str] = None, 
                          progress_callback=None, file_callback=None, scan_callback=None) -> Dict[str, Any]:
...
class TopRightInfoPanel(tk.Frame):
    ...
    def get_uptime(self):
        import time
        uptime_seconds = time.time() - psutil.boot_time() if 'psutil' in sys.modules else 3600
...
class DarkHackerGUI:
    ...
    def view_documentation(self):
        doc_text = """
UNIVERSAL COMMENT REMOVER v5.0
DOCUMENTATION

OVERVIEW:
This tool removes all types of comments from source code files while preserving
original files and creating new cleaned versions.

FEATURES:
- Supports 25+ programming languages
- Preserves shebang lines and encoding declarations
- Preserves Python docstrings
- String-literal aware (doesn't remove # inside strings)
- Automatic code formatting after comment removal
- Removes extra blank lines (max 1 empty line)
- Circular progress indicator
- Batch processing with folder structure preservation

HOW TO USE:
1. SINGLE FILE: Click 'PROCESS SINGLE FILE' and select a file
2. BATCH DIRECTORY: Click 'BATCH PROCESS DIRECTORY' and select a folder
3. For batch processing, a new folder 'folder - comments removed' is created

OUTPUT:
- Single file: Creates 'filename - comments removed.ext' in same folder
- Batch: Creates 'foldername - comments removed' with preserved structure

SUPPORTED LANGUAGES:
Python, JavaScript, TypeScript, HTML, CSS, C, C++, Java, C#, Go, Rust,
PHP, Ruby, Swift, Kotlin, SQL, XML, YAML, Shell, Perl, Lua, R, Dart
...
VERSION: 5.0
    ...
    def run(self):
        ...
        tk.Label(
            header_frame, text="COMPLETE COMMENT REMOVAL SYSTEM | PRESERVES ORIGINAL FILES | CODE FORMATTING",
        ...
        left_panel = tk.Frame(main_container, bg=style['bg_darker'], width=320)
        ...
        self.circular_progress.pack(pady=30)
        ...
        # Shortcut hints
        shortcut_label = tk.Label(status_bar, text="F11: FULLSCREEN | Ctrl+D: DOCS", font=('Consolas', 8),
                                  bg=style['bg_darker'], fg=style['fg_green_dark'])
